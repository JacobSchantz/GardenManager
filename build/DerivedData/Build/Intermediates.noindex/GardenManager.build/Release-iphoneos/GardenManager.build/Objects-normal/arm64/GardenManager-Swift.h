...
#ifndef GARDENMANAGER_SWIFT_H
#define GARDENMANAGER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GardenManager",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIApplication;
SWIFT_CLASS("_TtC13GardenManager11AppDelegate")
@interface AppDelegate : NSObject <UIApplicationDelegate>
- (BOOL)application:(UIApplication * _Nonnull)application didFinishLaunchingWithOptions:(NSDictionary<UIApplicationLaunchOptionsKey, id> * _Nullable)launchOptions SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC13GardenManager16GrokVoiceService")
@interface GrokVoiceService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class AVSpeechSynthesizer;
@class AVSpeechUtterance;
SWIFT_CLASS("_TtC13GardenManager20OpenClawVoiceService")
@interface OpenClawVoiceService : NSObject <AVSpeechSynthesizerDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
